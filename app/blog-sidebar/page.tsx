        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="shadow-three dark:bg-gray-dark mb-10 mt-12 rounded-sm bg-card p-6 dark:shadow-none lg:mt-0">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm bg-card dark:shadow-none">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm card dark:shadow-none">
                <h3 className="border-b border-body-color border-opacity-10 px-8 py-4 text-lg font-semibold text-black dark:border-white dark:border-opacity-10 dark:text-white">
                  Popular Category
                </h3>
