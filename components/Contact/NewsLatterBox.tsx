...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp dark:bg-gray-dark relative z-10 rounded-sm bg-card p-8 shadow-three sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      ...
      <p className="border-body-color text-body-color mb-11 border-b border-opacity-25 pb-11 text-base leading-relaxed dark:border-white dark:border-opacity-25">
        Get notified on new the latest update in our stack.
      </p>
      <div>
        <input
          type="text"
          ...
          className="border-stroke dark:text-body-color-dark text-body-color mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="hover:bg-primary/90 mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 dark:shadow-submit-dark"
        />
        <p className="dark:text-body-color-dark text-body-color text-center text-base leading-relaxed">
